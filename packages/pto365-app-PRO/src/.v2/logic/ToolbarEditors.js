...
//import PeriodicToolbarBanner from '../components/PeriodicToolbarBanner'
import ToolbarHeader from '../components/Toolbar/ToolbarHeader';
import ImagePicker from "../pickers/ImagePicker";
export class ToolbarProperties extends Component {
  state = {}
    render() {
        ...
        return (
            ...
            <div style={{marginLeft:"20px"}}>
                <ToolbarHeader imageUrl={this.props.titlegraphics} />
...
{/* <div style={{display:"flex"}}>
    <div>
           ...
           The Toolbar is responsive and will remove/add elements of the tiles and groups based on the available screen width and height.
...
export  class ToolbarPropertiesEditor extends Component {
state = {}
    _init = () =>{
      
        this.setState({toolbarProperties:{...this.props.settings}})
    }
    ...
    render() {
            ...
            return  (
            <EditorDialog title={"Toolbar Properties " } 
                          width="500px"
                          onSelect={()=>{
                             
                              if (this.props.onUpdate){
                                  this.props.onUpdate("contentRef",this.state.toolbarProperties)
                              }
                          }}
            ...
            >
                            ...
                            <ToolbarProperties {...this.state.toolbarProperties}
                                ...
                                onChange={(properties)=>{
                                var toolbarProperties = this.state.toolbarProperties
                                    _.keysIn(properties).map(key=>{
                                        toolbarProperties[key] = properties[key]
                                    })
                                    this.setState({toolbarProperties,canSelect:true})
